<x-app-layout>
    ...
    <section class="relative py-20 bg-slate-900 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <h1 class="text-4xl md:text-5xl font-bold text-white mb-4">About Phantom Realtors</h1>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div>
                    ...
                    <p class="text-gray-600 leading-relaxed mb-4">
                        Phantom Realtors is a leading real estate and lifestyle company specializing in buying, selling, and renting quality homes. We also provide top-notch building products and professional services to help you create your perfect living space.
                    </p>
                    <p class="text-gray-600 leading-relaxed mb-4">
