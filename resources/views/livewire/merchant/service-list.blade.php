                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50" wire:key="service-{{ $service->id }}">
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <button wire:click="deleteService({{ $service->id }})" wire:confirm="Are you sure you want to delete this service?" class="text-red-600 hover:text-red-700 text-sm font-medium">Delete</button>
                                    </div>
                                </td>
                            </tr>
                            @empty
