<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('merchant.products.create') }}" class="inline-flex items-center px-4 py-2 bg-amber-600 text-white rounded-lg font-semibold text-sm hover:bg-amber-700 transition">
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <a href="{{ route('merchant.products.edit', $product) }}" class="text-blue-600 hover:text-blue-700 text-sm font-medium">Edit</a>
                                        <form action="{{ route('merchant.products.destroy', $product) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this product?')">
                                            @csrf
                                            @method('DELETE')
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-8 text-center text-gray-500">
                                    ...
                                    <a href="{{ route('merchant.products.create') }}" class="text-amber-600 font-medium hover:text-amber-700">Add your first product</a>
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
