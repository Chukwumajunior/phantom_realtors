            ...
            <form action="{{ route('merchant.services.update', $service) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="space-y-6" x-data="{
                        ...
                        selectedGroup: '',
                        selectedCategory: '{{ old('category', $service->category->value) }}',
                        ...
                        init() {
                            ...
                            this.$watch('selectedCategory', (value, oldValue) => {
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="5" required x-model="description" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-amber-500 focus:ring-amber-500"></textarea>
